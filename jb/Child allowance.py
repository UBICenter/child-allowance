...
# Simulate new income given 1. childcare cost subsidy to household equal to childcare expenditure or 2. flat allowance of equal value using replace_cost flag. 

simdf.loc[simdf['replace_cost'] == True, 'new_inc'] = simdf.SPM_TOTVAL + simdf.SPM_CHILDCAREXPNS
simdf.loc[simdf['replace_cost'] == False, 'new_inc'] = simdf.SPM_TOTVAL + simdf.flat_transfer
